        ...
        return (
            <div>
                <div class="form-group">
                    ...
                    <input id="login" value={this.state.credentionals.login} onChange={this.onChangeLogin} type="login"
                           class="form-control" id="exampleInputLogin" aria-describedby="loginHelp"/>
                    <small id="loginHelp" class="form-text text-muted">We'll never share your login with anyone
                        else.</small>
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input id="password" value={this.state.credentionals.password} onChange={this.onChangePassword}
